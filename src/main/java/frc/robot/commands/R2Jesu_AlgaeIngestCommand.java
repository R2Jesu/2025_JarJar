...
public class R2Jesu_AlgaeIngestCommand extends Command {
   ...
   */
  public R2Jesu_AlgaeIngestCommand(R2Jesu_AlgaeSubsystem subsystem) {
  ...
  @Override
  public void execute() {
    m_subsystem.ingestAlgae(1.0);
  }
  
  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    m_subsystem.ingestAlgae(0);
  }
