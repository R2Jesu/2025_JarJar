...
public class R2Jesu_AlgaeRegurgitateCommand extends Command {
   ...
   */
  public R2Jesu_AlgaeRegurgitateCommand(R2Jesu_AlgaeSubsystem subsystem) {
  ...
  public void end(boolean interrupted) {
    m_subsystem.regurgitateAlgae(0);
  }
